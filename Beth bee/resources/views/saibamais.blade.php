...
@section('content_header')
        <h2 style="color: #FDC433;">Bem-vindo à página "Saiba Mais" do BETH BEE!</h2>
    @stop
    ...
    <div>
        ...
        <h3 style="color: #FDC433;">Objetivo do Projeto:</h3>
        ...
        <h3 style="color: #FDC433;">O Que Esperar:</h3>
        <ul>
        ...
        <h3 style="color: #FDC433;">Nosso Compromisso:</h3>
